...
class NotesPage extends StatefulWidget {
  ...
  const NotesPage({super.key, required this.songTitle, this.songId});
                ...
                children: [
                  ...
                  SplitButton(
                    ...
                    onOptionSelected: (index) {
                      debugPrint(
                        'NotesPage: onOptionSelected called with index: $index',
                      );
                      setState(() {
                        _selectedDownloadIndex = index;
                      });
                      debugPrint(
                        'NotesPage: _selectedDownloadIndex updated to: $_selectedDownloadIndex',
                      );
                    },
                  ),
                ],
